...
import { increasePlayerCash, decreasePlayerCash, borrowCash, accrueInterest, payLoan, buyFruit, sellFruit, getCurrentInventory, logTransactionLog } from './controller'
...
// accrueInterest()
// payLoan(2)
buyFruit(currentRegion, 'peach', 3333)
buyFruit(currentRegion, 'peach', 3333)
...
sellFruit(currentRegion, 'mango', 38)
